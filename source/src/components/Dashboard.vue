        ...
        <div>
            ...
            <div class="burger-table-rows">
                ...
                <div class="burger-table-row" v-for="burger in burgers" :key="burger.id">
                    ...
                    <div>
                        <ul>
                            <li v-for="(opcional, index) in burger.opcionais" :key="opcional.id">{{ opcional }}</li>
                        </ul>
                    </div>
                    <select name="status" class="status" @change="updatedBurger($event, burger.id)">
                        <option value="">Selecione</option>
                        <option v-for="item in status" :value="item.tipo" :key="item.id"
...
export default {
    ...
    methods: {
        ...
        async deleteBurger(id) {
            ...
            this.msg = `O pedido N° ${res.id} removido com sucesso!`;
